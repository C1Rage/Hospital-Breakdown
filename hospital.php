        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">HOSPITAL FEES</h1>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM hospital_breakdown";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . htmlspecialchars($row['pf_pooling']) . "</td>";
                ...
                <form id="editBreakdownForm" action="update_breakdown.php" method="POST" onsubmit="cleanCurrencyInputs()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">₱</span>
                                <input type="text" class="form-control" id="editPF" name="PF" required oninput="formatCurrency(this)">
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="editPool" class="form-label">PF-Pooling ₱</label>
                            <div class="input-group">
                                <span class="input-group-text">₱</span>
                                <input type="text" class="form-control" id="editPool" name="PF-Pooling" required oninput="formatCurrency(this)">
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="add_breakdown_hospital.php" method="POST" onsubmit="cleanCurrencyInputs()">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <label for="pool" class="form-label">PF-Pooling ₱</label>
                                    <div class="input-group">
                                        <span class="input-group-text">₱</span>
                                        <input type="text" class="form-control" id="pool" name="pool" required oninput="formatCurrency(this)">
                                    </div>
                                </div>
                            </div>
